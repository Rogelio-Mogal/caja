...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h3 class="card-title">NUEVO PRESTAMO ESPECIAL</h3>
    </div>
    <div class="card-body">
                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <h4>DETALLE DE SOCIO PARA PRÉSTAMO ESPECIAL</h4>
                        </div>
                    </div>
                </div>
                <div class="card-body text-dark">
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-12">
                            <div class="col mb-3">
                                <div class="form-outline">
                                    <span tabindex="2" data-mdb-toggle="tooltip" title="PRÉSTAMO ESPECIAL">
                                        {{ Form::hidden('hidde', null) }}
                                        {{ Form::hidden('concepto', null, ['id' => 'concepto', 'name' => 'concepto']) }}
                                        {{ Form::hidden('conceptoId', null, ['id' => 'conceptoId', 'name' => 'conceptoId']) }}
                                        <select class="select mb-2" name="prestamo_especial" id="prestamo_especial"
                                            required="true" data-mdb-clear-button="true">
                                            <option value="-1" hidden selected>-- Seleccione --</option>
                                            @forelse($prestamoEspecial as $row)
                                                <option value="{{$row->precio}}" data-plazos="{{$row->num_plazos}}" data-id="{{$row->id}}" data-concepto="{{$row->concepto}}">{{$row->concepto}}</option>
                                            @empty
                                            @endforelse
                                        </select>
                                        <label class="form-label select-label form-control-lg"
                                            for="prestamo_especial">PRÉSTAMO ESPECIAL</label>
                                    </span>
                                    <div class="form-helper" id="socio_feedback" style="color: red; display: none;">Este
                                        campo es requerido.</div>
                                </div>
                                @error('prestamo_especial')
                                    <p class="error-message text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                        </div>
                            ...
                            <div class="col mb-3">
                                <div class="form-outline">
                                    ...
                                    <span tabindex="2" data-mdb-toggle="tooltip" title="MONTO PRESTAMO">
                                        <div class="form-outline">
                                            {{ Form::text('monto_prestamo', null, ['id' => 'monto_prestamo', 'class' => 'form-control uppercase generaIntereses generaTotalAvalar','step'=>'any', 'placeholder' => 'MONTO PRESTAMO', 'required']) }}
                            ...
                            <div class="col mb-3">
                                <div class="form-outline">
                                    <span tabindex="2" data-mdb-toggle="tooltip" title="NÚM. NÓMINA">
                                        <div class="form-outline">
                                            {{ Form::number('num_nomina', null, ['id' => 'num_nomina', 'class' => 'form-control uppercase', 'placeholder' => 'NÚM. NÓMINA', 'required']) }}
                            ...
                            <div class="col mb-3">
                                <div class="form-outline">
                                    <span tabindex="2" data-mdb-toggle="tooltip" title="NÚM. EMPLEADO">
                                        <div class="form-outline">
                                            {{ Form::number('num_empleado', null, ['id' => 'num_empleado', 'class' => 'form-control uppercase', 'placeholder' => 'NÚM. EMPLEADO', 'required']) }}
...
@section('js')
    <script>
        $(document).ready(function() {
                ...
                if (form.checkValidity()) {
                    ...
                    switch (true) {
                        ...
                        default:
                            ...
                            document.getElementById('form_prestamos_especiales').submit();
                            $("#submitBtn").attr("disabled", true);
            ...
            $(document).on('change', '#prestamo_especial', function() {
                ...
                $("#total_quincenas").attr("min", 1);
                $("#total_quincenas").attr("max", plazos);
                ...
                if( precio < 0){
                    ...
                    $('#concepto').val('');
                    $('#conceptoId').val(0);
                    $("#total_quincenas").attr("min", 0);
                    $("#total_quincenas").attr("max", 0);
                }
            ...
            // Evitar entrada de datos en el campo al escribir
            var inputPrestamosIntereses = $('#monto_prestamo');
            inputPrestamosIntereses.on('keydown',
                function(e) {
                    e.preventDefault();
            });
            ...
            // Evitar entrada de datos en el campo al escribir
            var inputPrestamosIntereses = $('#total_quincenas');
            inputPrestamosIntereses.on('keydown',
                function(e) {
                    e.preventDefault();
            });
            ...
            */
            ...
            function tablainteresuno() {
                ...
                for (var i = 1; i <= mesesprest; i++) {
                    ...
                    interes = 0; //(montoprest / 100) * 1.5; // TASA DE INTERES
    ...
    @if (Session::has('advertencia'))
        <script type="text/javascript">
            Swal.fire({
                icon: 'warning',
                title: 'Ya no hay piezas disponibles.',
                text: 'Seleccione un nuevo préstamo especial.',
            });
        </script>
    @endif
