                                ...
                                <div class="form-outline">
                                    ...
                                    <span tabindex="2" data-mdb-toggle="tooltip" title="MONTO PRESTAMO">
                                        <div class="form-outline">
                                            ...
                                            {{ Form::hidden('monto_prestamo', old('monto_prestamo', $prestamo->monto_prestamo ?? 0), ['id' => 'monto_prestamo', 'class' => 'generaIntereses generaTotalAvalar']) }}
                                            <label class="form-label" for="monto_prestamo">MONTO
                                                PRESTAMO</label>
                                            <div class="invalid-feedback">
                                                Please provide a valid input.
                                            </div>
                                            <input id="monto_prestamos" name="monto_prestamos" type="hidden" value="0"
                                                step="any" />
                                        </div>
                                    </span>
                                </div>
                            ...
                            <div class="col mb-3">
                                <div class="form-outline">
                                    ...
                                    <span tabindex="2" data-mdb-toggle="tooltip" title="TOTAL QUINCENAS">
                                        <div class="form-outline">
                                            {{ Form::number('total_quincenas', old('total_quincenas', $prestamo->total_quincenas ?? 0), ['id' => 'total_quincenas', 'class' => 'form-control uppercase generaIntereses', 'placeholder' => 'TOTAL QUINCENAS', 'required']) }}
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-12">
                            <div class="col mb-3">
                                <div class="form-outline datepicker-translated" data-mdb-toggle-button="false">
                                    {{ Form::text('fecha_primer_pago', old(
    'fecha_primer_pago',
    isset($prestamo->fecha_primer_pago)
    ? \Carbon\Carbon::parse($prestamo->fecha_primer_pago)->format('d/m/Y')
    : null
), ['id' => 'fecha_primer_pago', 'name' => 'fecha_primer_pago', 'data-mdb-toggle' => 'datepicker', 'class' => 'form-control', 'placeholder' => 'FECHA DEL PRIMER PAGO']) }}
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-12">
                            <div class="col mb-3">
                                <div class="form-outline">
                                    <span tabindex="2" data-mdb-toggle="tooltip" title="NÚM. NÓMINA">
                                        <div class="form-outline">
                                            {{ Form::number('num_nomina', old('num_nomina', $prestamo->num_nomina ?? 0), ['id' => 'num_nomina', 'class' => 'form-control uppercase', 'placeholder' => 'NÚM. NÓMINA', 'required']) }}
                                            <label class="form-label" for="num_nomina">NÚM. NÓMINA</label>
                                            <div class="invalid-feedback">
                                                Please provide a valid input.
                                            </div>
                                        </div>
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-12">
                            <div class="col mb-3">
                                <div class="form-outline">
                                    <span tabindex="2" data-mdb-toggle="tooltip" title="NÚM. EMPLEADO">
                                        <div class="form-outline">
                                            {{ Form::number('num_empleado', old('num_nomina', $prestamo->num_nomina ?? 0), ['id' => 'num_empleado', 'class' => 'form-control uppercase', 'placeholder' => 'NÚM. EMPLEADO', 'required']) }}
                                            <label class="form-label" for="num_empleado">NÚM. EMPLEADO</label>
                                            <div class="invalid-feedback">
                                                Please provide a valid input.
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-outline">
                                        <span tabindex="3" data-mdb-toggle="tooltip" title="NÚMERO DE SOCIO">
                                            <input class="form-control" id="num_socio" type="text"
                                                value="NÚMERO DE SOCIO" aria-label="readonly input example" readonly />
                            ...
                            <div class="col mb-3">
                                <div class="form-outline">
                                    <span tabindex="5" data-mdb-toggle="tooltip" title="FECHA DE ALTA">
                                        <input class="form-control" id="fecha_alta" type="text" value="FECHA DE ALTA"
                                ...
                                <div class="form-outline">
                                    <span tabindex="8" data-mdb-toggle="tooltip" title="SALDO DISPONIBLE">
                                        <input class="form-control" id="disponible_socio" name="disponible_socio"
                                            type="text" value="SALDO DISPONIBLE" aria-label="readonly input example"
                                            readonly />
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-12">
                            <div class="col mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="copia_ine" id="copia_ine" {{ old('copia_ine', optional($prestamo)->documentacion['copia_ine'] ?? false) ? 'checked' : '' }}>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12">
                            <div class="col mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="credencial_socio"
                                        id="credencial_socio" {{ old('credencial_socio', optional($prestamo)->documentacion['credencial_socio'] ?? false) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="credencial_socio">Copia credencial de
                                        socio</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-12">
                            <div class="col mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="pagare" id="pagare" {{ old('pagare', optional($prestamo)->documentacion['pagare'] ?? false) ? 'checked' : '' }}>
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-12">
                            <div class="col mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="solicitud" id="solicitud" {{ old('solicitud', optional($prestamo)->documentacion['solicitud'] ?? false) ? 'checked' : '' }}>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-4 col-md-2">
                            ...
                            <input type="hidden" id="total_faltante_avalar_input" name="total_faltante_avalar_input"
                                value="0">
                            <input type="hidden" id="suma_faltante_avalar" name="suma_faltante_avalar" value="0">
                ...
                <div class="card-body text-dark">
                    <div
                            ...
                            <div class="col mb-3">
                                <div class="form-outline">
                                    ...
                                    <span tabindex="10" data-mdb-toggle="tooltip" title="AVALES">
                                        <select class="select mb-2" name="aval_id" id="aval_id" data-mdb-filter="true"
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-12">
                            <div class="col mb-3">
                                <div class="form-outline">
                                    <input class="form-control" id="saldo_disponible_aval" type="text" value="0"
                                        aria-label="readonly input example" readonly />
...
@if(isset($prestamo))
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            const hidden = document.getElementById('monto_prestamo');
            const display = document.getElementById('pp_display');

            if (hidden && display && hidden.value) {
                const number = parseFloat(hidden.value);

                display.value = number.toLocaleString('en-US', {
...
<script>
    ...
    $(document).ready(function () {
        const ES_EDIT = @json($edit);
        const DETALLES_PRESTAMO = @json($prestamo->detalles);
        ...
        submitBtn.addEventListener('click', function (event) {
            ...
            if (form.checkValidity()) {
                ...
                // Normalización
                saldoSocio = num(saldoSocio);
                prestamoIntereses = num(prestamoIntereses);
                totalFaltanteAvalar = num(totalFaltanteAvalar);

                console.log({
                    totalFaltanteAvalar,
                    fijo: totalFaltanteAvalar.toFixed(2)
                });
                ...
                switch (true) {
                    ...
                    */
                    ...
                    case socio_num_prestamo >= 3 && apoyoAdicional == 0:
                        console.log('case 7');
                        Swal.fire({
                            title: 'El socio ya superó los 3 préstamos',
                            html:
        ...
        //selecciona el soscio en edit
        $(document).on('select2:select', '#socios_id', function (e) {
            cargarDetalleSocio(e.params.data.id);
        });
        $(document).on('select2:clear', '#socios_id', function () {
            limpiarCamposSocio();
        });

        function cargarDetalleSocio(socioId) {
            // No ejecutar en CREATE
            if (!ES_EDIT) return;
            ...
            $.ajax({
                ...
                success: function (response) {
                    $(response).each(function (i, v) {
                        ...
                        $('#disponible_socio').val(formatToCurrency(v.saldo_disponible));
                        $('#monto_socio').val(v.saldo_disponible);
                        $('#disponible_aval').val(formatToCurrency(v.saldo * 2));
                        $('#monto_prestamo').attr('max', v.saldo_disponible * 2).trigger('change');
                ...
                error: function (err) {
                    console.error('Error socio:', err);
                }
            });
            // Bloquear select de socio
            $('#socios_id').prop('disabled', true);
        }

        function cargarAvalesDesdeEdit(detalles) {
            const tbody = document.querySelector('#tbl_aval tbody');
            tbody.innerHTML = '';

            detalles.forEach(detalle => {
                const socio = detalle.socio;
                const saldoDisponible = (
                    Number(socio.saldo) - Number(socio.monto_prestamos)
                ).toFixed(2);
                ...
                fila.innerHTML = `
                    <td>
                        ${socio.id}
                        <input type="hidden" name="idAval[]" value="${socio.id}">
                    </td>
                    ...
                    <td>${socio.rfc}</td>
                    <td>${saldoDisponible}</td>
                    <td>
                        <input
                            type="number"
                            name="saldo_aval[]"
                            class="form-control saldo_aval"
                            value="${detalle.monto_aval}"
                            step="any"
                            min="1"
                            max="${saldoDisponible}"
                            required
                    ...
                    <td>
                        <button type="button"
                                class="btn btn-danger btn-fab btn-fab-mini btn-round remove">
        ...
        // CARAGA AVALES EN EDIT
        if (ES_EDIT && DETALLES_PRESTAMO.length > 0) {
            cargarAvalesDesdeEdit(DETALLES_PRESTAMO);
            totalAvales()
        }
    ...
    function socios() {
        ...
        @if(isset($socio))
            ...
            // Forzamos carga de datos sin esperar interacción
            cargarDetalleSocio("{{ $socio->id }}");
        @endif
