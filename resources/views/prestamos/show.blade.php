    ...
    <div class="card card-outline card-primary solo-impresion">
        ...
        <table width="100%" cellspacing="0" border="0" cellpadding="0">
            <tbody>
                <tr>
                    <td rowspan="4">
                        <p class="text-center"><img class="masthead-avatar mb-5" src="{{ asset('image/caja.png') }}"
                                alt="SSPO_logo" width="90px" /></p>
                    </td>
        ...
        <table width="100%" cellspacing="0" border="0" cellpadding="0">
            <tbody>
                ...
                <tr>
                    ...
                    <td colspan="2">EN {{ number_format($prestamo->total_quincenas, 0, '.', '') }}</td>
        ...
        <table width="100%" cellspacing="0" border="0" cellpadding="0">
            <tbody>
                ...
                <tr>
                    ...
                    <td colspan="2">DEUDA: ${{ number_format($totalCapitalPendiente, 2) }}</td>  
                    <td colspan="2">QNA.{{ \Carbon\Carbon::parse($prestamo->fecha_primer_pago)->format('d/m/Y') }}</td>
                </tr>
                <tr>
                    <td colspan="6">
                        @if($socio->is_aval > 0)
        ...
        <table width="100%" cellspacing="0" border="0" cellpadding="0">
            <tbody>
                ...
                <tr>
                    <td colspan="8" class="border-l border-r">EN MI CARÁCTER DE SOLICITANTE AUTORIZO QUE EL DEPOSITO SEA REALIZADO A LA TARJETA NO.
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-12">
                                <div class="col">
                                    ...
                                    <h6>$ {{ number_format($prestamo->monto_prestamo,2) }} </h6>
                                </div>
                            </div>
                            <div class="col-lg-2 col-md-2 col-sm-12">
                                <div class="col">
                                    <h5><strong>TOTAL QUINCENAS</strong></h5>
                                    <h6>{{ number_format($prestamo->total_quincenas, 0, '.', '') }}</h6>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-12">
                                <div class="col">
                                    ...
                                    <h6>$ {{ number_format( $prestamo->pago_quincenal,2) }}</h6>
                                </div>
                            </div>
                            <div class="col-lg-2 col-md-2 col-sm-12">
                                <div class="col">
                                    <h5><strong>PRESTAMO + INTERESES</strong></h5>
                                    <h6>$ {{ number_format( ($prestamo->monto_prestamo + $prestamo->total_intereses),2) }}</h6>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-12">
                                <div class="col">
                                    <h5><strong>NÚM. NÓMINA</strong></h5>
                                    <h6>{{ $prestamo->num_nomina }}</h6>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-12">
                                <div class="col">
                                    <h5><strong>NÚM. EMPLEADO</strong></h5>
                                    <h6>{{ $prestamo->num_empleado }}</h6>
                                </div>
                            </div>
                            <div class="col-lg-2 col-md-2 col-sm-12">
                                <div class="col">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-12">
                                <div class="col">
                                    ...
                                    <h6>$ {{ number_format( $socio->saldo,2) }}</h6>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-12">
                                <div class="col">
                                    <h5><strong>SALDO DISPONIBLE</strong></h5>
                                    <h6>$ {{ number_format( ($socio->saldo + 500 - $socio->monto_prestamo), 2) }}</h6>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-12">
                                <div class="col">
                                    <h5><strong>SALDO DISPONIBLE</strong></h5>
                                    <h6>$ {{ number_format( (($socio->saldo + 500 - $socio->monto_prestamo) * 2),2) }}
                                    </h6>
                                </div>
                            </div>
                        </div>
