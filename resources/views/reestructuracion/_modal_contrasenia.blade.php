                 ...
                 <div class="row mb-3">
                     <div class="col-lg-12 col-md-12 col-sm-12">
                         <div class="col">
                             ...
                             <h6><span id="socio">{{ $usuario->nombre_completo }}</span></h6>
                             <input type="hidden" class="modalSocio" value="{{ $usuario->nombre_completo  }}">
                             <input type="hidden" class="modalIdSocio" value="{{ $usuario->id  }}">
                         </div>
                     </div>
                 </div>
                 <div class="row mb-3">
