        ...
        $(document).ready(function() {
            ...
            submitBtn.addEventListener('click', function(event) {
                ...
                if (form.checkValidity()) {
                    ...
                    var prestamoIntereses = $('#prestamo_intereses').val();
                    ...
                    switch (true) {
                        case $('#socios_id').val() === '-1':
                            ...
                            $('#socio_feedback').show();
                            break;
                        case totalFaltanteAval > 0 && tablaAval.rows.length == 1:
                            console.log('case 2');
                            Swal.fire({
                                icon: 'error',
            ...
            $('.generaIntereses').change(function() {
            ...
            $('.generaTotalAvalar').change(function() {
                totalAvales();
            });
            ...
            function avales(id, tipo, accion) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        } else if (filas.length > 0 && filas.length <= 2) {
            ...
            function totalAvales() {
                ...
                console.log('------------------------------------: ');
                console.log('prestamoIntereses: '+prestamoIntereses);
                console.log('saldoSocio: '+saldoSocio);
                console.log('monto_socio: '+saldoSocio);
                console.log('totalAvalar: '+totalAvalar);
                console.log('faltanteAvalar: '+faltanteAvalar);
