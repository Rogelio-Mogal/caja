...
@section('content')
    ...
    <div class="card card-outline card-primary">
        <div class="card-header">
            <h3 class="card-title">Reestructuración</h3>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a class="dropdown-item"
                                                                href="{{ Route('admin.reestructuracion.show', $row->id) }}">Ver
                                                                prestamos</a>
                                                        </li>
                                                    </ul>
                                                </div>
...
@section('js')
    ...
    @if (Session::has('correcto'))
        <script type="text/javascript">
            ...
            Swal.fire({
                icon: 'success',
                title: 'Préstamos pagado. ',
                text: 'El préstamos de '+name+' han sido pagado.',
            });
            setTimeout(function() {
                window.open("{{ url('/recibo-reestructuracion-prestamo-pagado') }}/" + id, '_blank');
            }, 200);
        </script>
    @endif
