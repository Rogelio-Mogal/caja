                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2" class="b-bottom"
                            ...
                            {{ date('d-m-Y H:i:s', strtotime($retiro->fecha_retiro)) }}</td>
                    </tr>
                    <tr>
                        <td colspan="2" class="b-bottom"
            ...
            <table class="table item_table2" width="100%" cellspacing="0" border="0" cellpadding="0">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="font-size: 1rem; padding-top: 4; text-align: center;">${{ number_format ( $retiro->saldo_aprobado + $retiro->saldo_actual, 2) }}</td>
                        <td style="font-size: 1rem; padding-top: 4; text-align: center;">${{ number_format ( $retiro->saldo_aprobado, 2) }}</td>
                        <td style="font-size: 1rem; padding-top: 4; text-align: center;">${{ number_format ( $retiro->saldo_actual, 2) }}</td>
                    </tr>
                    <tr>
                        <td colspan="4" style="font-size: 1rem; padding-top: 4; padding-left: 10px">
                            <p class="uppercase">FORMA DE PAGO: {{ $retiro->forma_pago }}</p>
                        </td>
                    </tr>
                ...
                <tfoot>
                    ...
                    <tr>
                        <td colspan="4" style="font-size: 1rem; padding-top: 4; padding-left: 10px">
                            IMPORTE CON LETRA: <strong> {{ convertir(number_format($retiro->saldo_aprobado, 2)) }} </strong>
                        </td>
                    </tr>
                </tfoot>
