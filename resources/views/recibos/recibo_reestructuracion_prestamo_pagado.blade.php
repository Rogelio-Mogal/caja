...
<head>
    <title>REESTRUCTURACIÓN PRÉSTAMO PAGADO</title>
        ...
        <div class="contenido">
                ...
                <tbody>
                    <tr>
                        ...
                        <td rowspan="2" style="width: 300;" align="center" class="b-bottom b-right">
                            ...
                            <h2>REESTRUCTURACIÓN PRÉSTAMO PAGADO</h2>
                        </td>
                    ...
                    <tr>
                        <td colspan="2" class="b-bottom"
                            ...
                            {{ date('d-m-Y H:i:s', strtotime($prestamo->fecha_prestamo)) }}</td>
                    </tr>
                    <tr>
                        <td colspan="2" class="b-bottom"
            ...
            <table class="table item_table2" width="100%" cellspacing="0" border="0" cellpadding="0">
                <tbody>
                    ...
                    <tr>
                        <td style="font-size: 1rem; padding-top: 4; padding-left: 10px">
                            REESTRUCTURACIÓN PRÉSTAMO PAGADO
                        </td>
                        <td style="font-size: 1rem; padding-top: 4; text-align: center;">
                            ${{ number_format ( $prestamo->monto_prestamo, 2) }}</td>
                        <td style="font-size: 1rem; padding-top: 4; text-align: center;">
                            ${{ number_format ( $prestamo->pago_quincenal, 2) }}</td>
                    ...
                    <tr>
                        <td colspan="4" style="font-size: 1rem; padding-top: 4; padding-left: 10px">
                            <p class="uppercase">FORMA DE PAGO: {{ $prestamo->metodo_pago }}</p>
                        </td>
                    </tr>
                ...
                <tfoot>
                    ...
                    <tr>
                        <td colspan="4" style="font-size: 1rem; padding-top: 4; padding-left: 10px">
                            IMPORTE CON LETRA: <strong> {{ convertir(number_format($prestamo->pago_quincenal, 2)) }}
                            </strong>
                        </td>
                    </tr>
                </tfoot>
