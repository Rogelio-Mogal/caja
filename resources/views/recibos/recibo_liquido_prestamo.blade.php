...
<head>
    <title>COMPROBANTE LIQUIDO DE PRÉSTAMO</title>
        ...
        <div class="contenido">
                ...
                <tbody>
                    <tr>
                        ...
                        <td rowspan="2" style="width: 300;" align="center" class="b-bottom b-right">
                            ...
                            <h2>COMPROBANTE PAGO DE PRÉSTAMO</h2>
                        </td>
                    ...
                    <tr>
                        <td colspan="2" class="b-bottom"
                            ...
                            {{ date('d-m-Y H:i:s', strtotime($liquido[0]->fecha_pago_reestructuracion)) }}</td>
                    </tr>
                    <tr>
                        <td colspan="2" class="b-bottom"
                        ...
                        <td colspan="2" class="b-bottom"
                            ...
                            {{ $liquido[0]->num_socio }}</td>
                    </tr>
                    <tr>
                        <td colspan="2" class="b-bottom"
                            style="font-size: 1rem; padding-bottom: 3; padding-top: 3; padding-left: 10px; ">FORMA DE PAGO:
                            {{ $liquido[0]->forma_pago }}
                        </td>
                        <td colspan="2" class="b-bottom"
                            style="font-size: 1rem; padding-bottom: 3; padding-top: 3; padding-left: 10px; ">REFERENCIA:
                            {{ $liquido[0]->referencia }}
                        </td>
                    </tr>
                    <tr>
                        <td colspan="4" class="b-bottom"
                            style="font-size: 1rem; padding-bottom: 3; padding-top: 3; padding-left: 10px; ">NOMBRE:
                            {{ $liquido[0]->nombre_completo }}</td>
                    </tr>
                    <tr>
                        <td colspan="4">
            ...
            <table class="table item_table2" width="100%" cellspacing="0" border="0" cellpadding="0">
                <tbody>
                    ...
                    @foreach($liquido as $row)
                        @php
                            $suma_importe += $row->capital_con_forma_pago;
                        @endphp
                        <tr>
                ...
                <tfoot>
                    ...
                    <tr>
                        <td colspan="4" style="font-size: 1rem; padding-top: 4px; padding-left: 10px;">
                            IMPORTE CON LETRA: <strong>{{ convertir($suma_importe, 2) }}</strong>
                        </td>
                    </tr>
                </tfoot>
            </table>
