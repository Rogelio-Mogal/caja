...
<head>
    <title>COMPROBANTE DEVOLUCIÓN</title>
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2" class="b-bottom"
                            ...
                            {{ date('d-m-Y H:i:s', strtotime($devolucion->fecha_devolucion)) }}</td>
                    </tr>
                    <tr>
                        <td colspan="2" class="b-bottom"
                    ...
                    <tr>
                        <td colspan="4" class="b-bottom"
                            ...
                            {{ $devolucion->socio->nombre_completo }}</td>
                    </tr>
                    <tr>
                        <td colspan="4">
            ...
            <table class="table item_table2" width="100%" cellspacing="0" border="0" cellpadding="0">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="font-size: 1rem; padding-top: 4; text-align: center;">$ {{ number_format( $devolucion->importe,2) }}</td>
                    </tr>
                ...
                <tfoot>
                    ...
                    <tr>
                        <td colspan="2" style="font-size: 1rem; padding-top: 4; padding-left: 10px">
                            IMPORTE CON LETRA: <strong> {{ convertir( $devolucion->importe,2) }} </strong>
                        </td>
                    </tr>
                </tfoot>
